...
class VerificationScreen extends BaseRoute {
  VerificationScreen({a, o}) : super(a: a, o: o, r: 'VerificationScreen');
  @override
  _VerificationScreenState createState() => _VerificationScreenState();
}

class _VerificationScreenState extends BaseRouteState {
  File imageFile;
  File _tImage;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text(AppLocalizations.of(context).lbl_add_id_photos),
        ),
