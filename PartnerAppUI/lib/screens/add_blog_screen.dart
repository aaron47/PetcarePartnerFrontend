...
class _AddBlogScreenState extends BaseRouteState {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text(
            AppLocalizations.of(context).lbl_add_new_blog,
          ),
        ),
              ...
              child: Column(
                children: [
                  Card(
                    child: TextFormField(
                      decoration: InputDecoration(
                        labelText: AppLocalizations.of(context).lbl_title,
                        hintText: AppLocalizations.of(context).hnt_enter_title,
                      ),
                    ),
                  ),
                  Card(
                    child: TextFormField(
                      decoration: InputDecoration(
                        labelText: AppLocalizations.of(context).lbl_details,
                        hintText: AppLocalizations.of(context)
                            .lbl_blog_details_description,
                      ),
                      maxLines: 3,
                    ),
                  ),
                  ...
                  Card(
                    child: TextFormField(
                      decoration: InputDecoration(
                        labelText: AppLocalizations.of(context).lbl_blog_date,
                        hintText: '25 Jun, 2019 10:30 PM',
                      ),
                    ),
                  ),
                  Column(
                    children: [
                      Padding(
                        ...
                        child: Text(
                          AppLocalizations.of(context).txt_add_image,
                          style:
                              Theme.of(context).inputDecorationTheme.labelStyle,
                        ),
                      ),
        ...
        bottomNavigationBar: Container(
            ...
            child: TextButton(
                ...
                child: Text(
                  AppLocalizations.of(context).btn_verify_blogs,
                ))));
  }
